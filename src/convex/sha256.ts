/**
 * Minimal, dependency-free SHA-256 (FIPS 180-4) — hex digest of a UTF-8
 * string. Used to hash CLI tokens so the plaintext never touches the
 * database. Pure JS on purpose: Convex's default runtime has no node:crypto,
 * and adding a hashing dependency for one use is not worth it.
 */
